  subroutine vca_get_density_matrix_single(dm_,custom_rot,dm_eig_,dm_rot_)
    implicit none
    !passed
    ...
    !
  end subroutine vca_get_density_matrix_single



  subroutine vca_get_density_matrix_lattice(dm_,custom_rot,dm_eig_,dm_rot_)
    implicit none
    !passed
    complex(8),allocatable,intent(out)           :: dm_(:,:,:)
    complex(8),allocatable,intent(in) ,optional  :: custom_rot(:,:)
    ...
    do ilat=1,Nlat
       ...
       !
    enddo
  end subroutine vca_get_density_matrix_lattice
